Pod::Spec.new do |s|
  ...
  s.source   = { :git => 'https://github.com/Labgoo/nimbus.git' }
  ...
  s.subspec 'TextField' do |text_field|
    text_field.source_files = 'src/textfield/src'
    text_field.dependency 'Nimbus/Core'
  end
